...
const CourseDetail = () => {
  ...
  const fetchCourseDetails = async () => {
    setLoading(true);
    try {
      const response = await fetch(`/api/course-schedule/${courseId}`);
      if (!response.ok) {
        ...
        <div className="bg-white rounded-lg shadow p-4 mb-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{courseDetails?.date || "N/A"}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 mb-1">Location</p>
              <p className="font-medium">{courseDetails?.location || "N/A"}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium">{courseDetails?.durationDay || "0"} days</p>
            </div>
          </div>
        </div>
