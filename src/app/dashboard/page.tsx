        ...
        if (data.data) {
          setDashboardData({
            ...
            certificationTypeData:
              data.data.certificationTypeData || fallbackCertificationTypeData,
            upcomingTrainings:
              data.data.upcomingTrainings || fallbackUpcomingTrainings,
            pendingPaymentsCount: data.data.pendingPaymentsCount || 0,
            user: {
