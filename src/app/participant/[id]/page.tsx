...
import { User, Phone, Mail, Briefcase, Calendar, MapPin, Award, Book, CreditCard } from "lucide-react";
      ...
      <div className="p-2 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg p-3 shadow-sm mb-3">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-base font-medium text-gray-700">{participant.full_name}</h1>
        ...
        <div className="flex overflow-x-auto mb-3 bg-white rounded-md shadow-sm text-xs">
          ...
          <button
            ...
            className={`px-3 py-2 whitespace-nowrap ${
              activeTab === "courses" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-600"
            }`}
          >
            Courses
          </button>
          <button
            ...
            className={`px-3 py-2 whitespace-nowrap ${
              activeTab === "certificates" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-600"
            }`}
          >
            Certificates
          </button>
          <button
            ...
            className={`px-3 py-2 whitespace-nowrap ${
              activeTab === "payments" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-600"
            }`}
          >
            Payments
          </button>
        ...
        {activeTab === "dashboard" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="bg-white rounded-lg p-3 shadow-sm">
              <h2 className="text-sm font-medium text-gray-700 mb-2">Personal Information</h2>
              <div className="space-y-1.5 text-xs">
                <div className="flex items-center gap-2">
                  <User size={14} className="text-gray-500" />
                  <div>
                    <span className="text-gray-500">Full Name:</span>
                    <span className="ml-1 text-gray-700">{participant.full_name}</span>
                  </div>
                </div>
                {participant.gender && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="ml-1 text-gray-700">{participant.gender}</span>
                    </div>
                  </div>
                )}
                ...
                {participant.address && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="ml-1 text-gray-700">{participant.address}</span>
                    </div>
                  </div>
                )}
              </div>
        ...
        {activeTab === "courses" && (
          <div className="bg-white rounded-lg p-3 shadow-sm">
            <h2 className="text-sm font-medium text-gray-700 mb-2">Enrolled Courses</h2>
        ...
        {activeTab === "certificates" && (
          <div className="bg-white rounded-lg p-3 shadow-sm">
            <h2 className="text-sm font-medium text-gray-700 mb-2">Certificates</h2>
        ...
        {activeTab === "payments" && (
          <div className="bg-white rounded-lg p-3 shadow-sm">
            <h2 className="text-sm font-medium text-gray-700 mb-2">Payment History</h2>
            {participant.payments && participant.payments.length > 0 ? (
              <div className="space-y-2">
                {participant.payments.map((payment: any) => (
