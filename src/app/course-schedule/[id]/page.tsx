...
import { FileText, Edit, Trash2, History, UserCheck, Award, FileSignature, BarChart, Info, XCircle, Menu, ArrowUp, ArrowDown, Users, UserPlus, BookOpen } from "lucide-react";
      ...
      <div className="p-2">
                      ...
                      <div className="border rounded-md p-2">
                        ...
                        >
                          ...
                          <div className="mt-1 flex justify-between items-center">
                            <span className="text-xs text-blue-600">View Full Image</span>
                            <span className="text-xs text-gray-500">
                              {detailData.courseInfo.payment.verifiedAt ? 
                                `Verified on ${new Date(detailData.courseInfo.payment.verifiedAt).toLocaleDateString()}` : 
                                'Not verified yet'}
                            </span>
                          </div>
                        </a>
        ...
        {isEditValueModalOpen && selectedValueForEdit && (
          <Modal onClose={() => {
            ...
            <div className="p-2">
              <h2 className="text-xl font-semibold text-gray-700 mb-4">Edit Value</h2>
